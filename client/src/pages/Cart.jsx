...
const Cart = () => {
    const {products, currency, user, cartItems, updateCartItem, navigate, getCartAmount,removeFromcart, getCartCount, axios,setCartItems} = useAppContext();
        ...
        <div className="flex flex-col md:flex-row mt-16">
            <div className='flex-1 max-w-4xl'>
                ...
                <button  onClick={()=> {navigate('/products'); scrollTo(0,0)}} className="group cursor-pointer flex items-center mt-8 gap-2 text-primaryfont-medium">
                   <img src={assets.arrow_right_icon_colored} alt="araow"  className="group-hover:-translate-x-1 transition"/>
                    Continue Shopping
                </button>
